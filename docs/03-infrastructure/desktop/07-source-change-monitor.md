...
(`lib/infrastructure/io/desktop_source_change_monitor.dart:15-26`).
...
(`lib/infrastructure/io/desktop_source_change_monitor.dart:28-105`).
...
one directory signal (`lib/infrastructure/io/desktop_source_change_monitor.dart:108-128`).
...
capabilities (`lib/infrastructure/platform/platform_io.dart:47-76`).
...
(`lib/infrastructure/io/desktop_source_change_monitor.dart:248-264`).
...
(`lib/infrastructure/io/desktop_source_change_monitor.dart:130-150`,
`:231-245`). On macOS, security-scoped bookmarks are held for the lifetime of
the watch and released in `dispose`, allowing changes to remain observable
inside the sandbox (`lib/infrastructure/io/desktop_source_change_monitor.dart:186-195`,
`:238-244`).
...
(`lib/infrastructure/io/desktop_source_change_monitor.dart:197-228`).
