...
and saved (`lib/application/use_cases/remove_markdown.dart`, `lib/application/use_cases/remove_markdown.dart`).
...
mutations (`lib/main.dart`). The controller calls it only from shelf
intent (`lib/api/reader_controller.dart`).
