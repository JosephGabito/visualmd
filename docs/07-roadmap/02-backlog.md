...
| Reveal the themes folder | Kernel fix | infrastructure, api | The theme menu prints the path (`lib/api/widgets/theme_picker.dart:51-54`); opening it in the file manager needs one more platform capability. |
