  ...
  DesktopCommands() {
    _channel.setMethodCallHandler((call) async {
      final command = switch (call.method) {
        ...
        'copySelection' => PlatformCommand.copySelection,
        'selectAllText' => PlatformCommand.selectAllText,
  ...
  Future<void> syncReaderState(NativeReaderState state) async {
    try {
      await _channel.invokeMethod<void>('updateReaderState', {
        ...
        'canIncreaseText': state.canIncreaseText,
        'canDecreaseText': state.canDecreaseText,
        'canResetText': state.canResetText,
